...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="post-header" >
		<?php 
			...
			if( is_single() ){
				echo '<h1 class="gdlr-blog-title"><a target="_blank" href="' . $blog_link . '" >' . get_the_title() . '</a></h1>';
			}else{
				echo '<h3 class="gdlr-blog-title"><a target="_blank" href="' . $blog_link . '" >' . get_the_title() . '</a></h3>';
			}
