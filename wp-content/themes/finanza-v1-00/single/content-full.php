	...
	<div class="gdlr-standard-style">
		...
		<div class="blog-content-wrapper" >
			<header class="post-header">
				...
				<?php }else{ ?>
					<h3 class="gdlr-blog-title"><a target="_blank" href="<?php echo get_permalink(); ?>"><?php the_title(); ?></a></h3>
				<?php } ?>	
				
				<?php echo gdlr_get_blog_info(array('date', 'author', 'comment', 'category'), true, '<span class="gdlr-sep">/</span>', 'text');  ?>
				<div class="clear"></div>
			</header><!-- entry-header -->
