<?php
	...
	*/
	...
	define('THEME_FULL_NAME', 'Finanza');
	define('THEME_SHORT_NAME', 'finz');
	define('THEME_SLUG', 'finanza');
	...
	// body class
	add_filter('body_class', 'gdlr_body_classes');
	function gdlr_body_classes($classes) {
		global $theme_option;
		if( !empty($theme_option['flex-carousel-auto-scroll']) && $theme_option['flex-carousel-auto-scroll'] == 'disable' ){
			$classes[] = 'gdlr-carousel-no-scroll';
		}
		return $classes;
	}
