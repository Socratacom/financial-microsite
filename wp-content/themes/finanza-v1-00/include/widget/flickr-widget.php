	...
	class Goodlayers_Flickr_Widget extends WP_Widget{
		...
		function widget( $args, $instance ) {
			...
			if(!empty($id)){ 
				...
				?>
					...
					<script type="text/javascript" src="http://www.flickr.com/badge_code_v2.gne<?php echo gdlr_escape_content($flickr); ?>"></script>
					<div class="clear"></div>
					</div>
				<?php
			}
		...
		function form( $instance ) {
			...
			<p>
				...
				<input class="widefat" id="<?php echo $this->get_field_id('id'); ?>" name="<?php echo $this->get_field_name('id'); ?>" type="text" value="<?php echo gdlr_escape_content($id); ?>" />
			</p>			
