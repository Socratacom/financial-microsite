...
add_action( 'widgets_init', 'gdlr_port_slider_widget' );
if( !function_exists('gdlr_port_slider_widget') ){
	function gdlr_port_slider_widget() {
		...
		function form( $instance ) {
			...
			<p>
				...
				foreach($thumbnails as $th_slug => $th_name){ ?>
					<option value="<?php echo gdlr_escape_content($th_slug); ?>" <?php if ($thumbnail_size == $th_slug) echo ' selected '; ?>><?php echo gdlr_escape_content($th_name); ?></option>				
				<?php } ?>	
				</select> 
			</p>			
